...
struct D3D12TextureViewSet {
    ...
    bool HasNv12Srv() const noexcept { return ySrvIndex != UINT_MAX && uvSrvIndex != UINT_MAX; }
    bool HasNv12Uav() const noexcept { return yUavIndex != UINT_MAX && uvUavIndex != UINT_MAX; }
